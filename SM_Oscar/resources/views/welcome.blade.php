    ...
    <nav class="uim-subnav text-white" aria-label="Navegación investigación UIM">
        <div class="container-fluid px-3 px-lg-4 uim-subnav-inner">
            <ul class="nav flex-nowrap overflow-x-auto py-1 mb-0 gap-1 justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ config('uim.urls.revista_figuras') }}" target="_blank"
...
@section('content')
    ...
    <section class="bg-secondary-subtle bloque-carrucel d-flex align-items-center shadow-sm"
        aria-label="Carrusel principal UIM">
        <div id="carousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active" data-bs-interval="5000">
                    <img src="{{ asset('dashboard/img1.jpg') }}" class="d-block w-100"
                        alt="Campus y actividades de la FES Acatlán — UNAM">
                ...
                <div class="carousel-item" data-bs-interval="5000">
                    <img src="{{ asset('dashboard/img2.jpg') }}" class="d-block w-100"
                        alt="Investigación en la FES Acatlán">
                    <div class="carousel-caption">
                ...
                <div class="carousel-item" data-bs-interval="5000">
                    <img src="{{ asset('dashboard/img3.jpg') }}" class="d-block w-100"
                        alt="Difusión y formación en investigación">
                    <div class="carousel-caption">
    ...
    <div class="container-fluid px-3 px-lg-4 py-4">
        ...
        <div class="row g-4 align-items-start">
                ...
                <div class="bloque-principal1 p-3 p-md-4 text-body-secondary">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            {{-- NOTA: id para ancla desde el menú lateral (#uim-proposito), patrón típico en sitios
                            institucionales. --}}
                            ...
                            <p class="lead fs-6 text-body-secondary mb-3">
                                La <strong class="text-body">Unidad de Investigación Multidisciplinaria (UIMA)</strong> de
                                la
                                <strong class="text-body">FES Acatlán — UNAM</strong> articula esfuerzos de generación de
                                conocimiento
            ...
            <div class="col-12 col-lg-4 uim-carousel-side">
                ...
                {{-- NOTA (contenido): tres tarjetas por slide, sin duplicar “Investigación”; enlaces coherentes con el menú
                del portal FES. --}}
                <div id="tarjetasCarousel" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="d-flex flex-column gap-3">
                                <div class="bloque-sec p-3 rounded expandable">
                                    ...
                                    <p class="resumen mb-0">
                                        Marco general de la investigación en la FES Acatlán y el vínculo con la docencia y
                                        la cultura.
                                    </p>
                                    <div class="extra">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 mt-2">
                                        ...
                                        <a href="{{ url('/') }}#uim-proposito" class="btn btn-warning btn-sm">Ir al
                                            propósito</a>
                                    </div>
                                </div>
                                ...
                                <div class="bloque-sec p-3 rounded expandable">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 mt-2">
                                        <button type="button" class="btn btn-light btn-sm btn-toggle">Ver más</button>
                                        <a href="{{ url('/investigacion') }}" class="btn btn-warning btn-sm">Ir a
                                            seminarios</a>
                                    </div>
                                </div>
                                ...
                                <div class="bloque-sec p-3 rounded expandable">
                                    ...
                                    <div class="extra">
                                        <p class="small mb-0 mt-2">
                                            Ejemplos de ámbitos: ciencias sociales, humanidades, exactas y disciplinas
                                            afines.
                                        </p>
                                    </div>
                                    <div class="d-flex flex-wrap gap-2 mt-2">
                        ...
                        <div class="carousel-item">
                            <div class="d-flex flex-column gap-3">
                                <div class="bloque-sec p-3 rounded expandable">
                                    ...
                                    <div class="extra">
                                        <p class="small mb-0 mt-2">
                                            Publicación cuatrimestral; difusión de artículos y ensayos en varias áreas del
                                            conocimiento.
                                        </p>
                                    </div>
                                    <div class="d-flex flex-wrap gap-2 mt-2">
                                        <button type="button" class="btn btn-light btn-sm btn-toggle">Ver más</button>
                                        <a href="{{ config('uim.urls.revista_figuras') }}" class="btn btn-warning btn-sm"
                                            target="_blank" rel="noopener noreferrer">Abrir revista</a>
                                    </div>
                                </div>
                                ...
                                <div class="bloque-sec p-3 rounded expandable">
                                    ...
                                    <div class="extra">
                                        <p class="small mb-0 mt-2">
                                            Útil para contrastar este demo Laravel con las páginas administradas por la
                                            Facultad.
                                        </p>
                                    </div>
                                    <div class="d-flex flex-wrap gap-2 mt-2">
                                        <button type="button" class="btn btn-light btn-sm btn-toggle">Ver más</button>
                                        <a href="{{ config('uim.urls.uim_oficial') }}" class="btn btn-warning btn-sm"
                                            target="_blank" rel="noopener noreferrer">Portal FES (UIM)</a>
                                    </div>
                                </div>
                                ...
                                <div class="bloque-sec p-3 rounded expandable">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 mt-2">
                                        <button type="button" class="btn btn-light btn-sm btn-toggle">Ver más</button>
                                        <a href="{{ config('uim.urls.portal_fes') }}" class="btn btn-warning btn-sm"
                                            target="_blank" rel="noopener noreferrer">Portal FES Acatlán</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#tarjetasCarousel"
                        data-bs-slide="prev">
                        <span class="carousel-control-prev-icon"></span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#tarjetasCarousel"
                        data-bs-slide="next">
                        <span class="carousel-control-next-icon"></span>
                    </button>
                </div>
                ...
                <div class="d-flex flex-column gap-2 mt-3">
                    <a href="{{ config('uim.urls.uim_oficial') }}" class="btn btn-warning btn-sm w-100" target="_blank"
                        rel="noopener noreferrer">Sitio UIM en la FES</a>
                    <a href="{{ config('uim.urls.revista_figuras') }}" class="btn btn-outline-secondary btn-sm w-100"
                        target="_blank" rel="noopener noreferrer">Revista FIGURAS</a>
                </div>
            </div>
            ...
            <div class="col-12 uim-congresos-section" id="uim-congresos">
                <div class="d-flex flex-column flex-md-row align-items-md-end justify-content-between gap-2 mb-3">
                    <div>
                        ...
                        <p class="text-body-secondary small mb-0">Encuentros académicos de la UIM; detalle e inscripción por
                            evento.</p>
                    </div>
                </div>
                        ...
                        <div class="row g-0 align-items-stretch">
                            <div class="col-md-4 col-lg-3">
                                <img src="{{ $congreso->urlPortada() }}" class="img-fluid w-100 h-100 object-fit-cover"
                                    style="min-height: 160px;" alt="{{ $congreso->titulo }}">
                            </div>
                            <div class="col-md-8 col-lg-9">
                                <div class="card-body p-3 p-md-4">
                                    ...
                                    <div class="small text-body-secondary mb-2">
                                        ...
                                        @endif
                                        @if($congreso->sede)
                                            <span class="ms-md-3 d-inline-block"><i
                                                    class="bi bi-geo-alt me-1 text-warning"></i>{{ $congreso->sede }}</span>
                                        @endif
                                    </div>
                                    @if($congreso->resumen)
                                        <p class="small text-body mb-3 mb-md-0">
                                    ...
                                    <div class="d-flex flex-column flex-sm-row flex-wrap gap-2 mt-3">
                                        <a href="{{ route('congresos.show', $congreso) }}"
                                            class="btn btn-outline-secondary btn-sm">Ver congreso</a>
                                        @if($congreso->enlace_inscripcion)
                                            <a href="{{ $congreso->enlace_inscripcion }}" class="btn btn-warning btn-sm"
                                                target="_blank" rel="noopener noreferrer">Inscribirme</a>
                                        @else
            ...
            <div class="col-12 uim-events-section">
                ...
                <p class="text-body-secondary small mb-3">
                    {{-- NOTA (docencia): imágenes y títulos de muestra; en producción sustituir por datos desde base de
                    datos o CMS. --}}
                    Formato de carrusel para convocatorias, seminarios o cultura (similar a los bloques de avisos del portal
                    de la FES Acatlán).
                </p>
