...
<section class="py-5 bg-surface-container-lowest">
    <div class="container py-4">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-5 gap-3">
            <div>
                <span class="text-secondary-uim fw-bold tracking-widest small text-uppercase mb-3 d-block">Actualidad</span>
                    ...
                    <div class="p-2 p-md-4 d-flex flex-column flex-grow-1">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <span class="bg-blue-50-uim text-primary-uim fw-bold text-uppercase tracking-widest px-2 py-1 rounded-pill d-none d-sm-inline-block"
                                style="font-size: 0.6rem;">Seminario</span>
                            <span class="text-outline-uim font-label" style="font-size: 0.65rem;">Oct 24</span>
                        </div>
                        <h3 class="font-headline fs-6 fw-bold text-primary-uim mb-2" style="font-size: 0.85rem !important;">Nuevas perspectivas en la investigación 2024</h3>
                        <p class="text-on-surface-variant small mb-3 line-clamp-2 d-none d-sm-block">Se invita a la comunidad académica a participar en el ciclo de conferencias...</p>
                    ...
                    <div class="p-2 p-md-4 d-flex flex-column flex-grow-1">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <span class="bg-amber-50-uim text-secondary-uim fw-bold text-uppercase tracking-widest px-2 py-1 rounded-pill d-none d-sm-inline-block"
                                style="font-size: 0.6rem;">Publicación</span>
                            <span class="text-outline-uim font-label" style="font-size: 0.65rem;">Oct 12</span>
                        </div>
                        <h3 class="font-headline fs-6 fw-bold text-primary-uim mb-2" style="font-size: 0.85rem !important;">Presentación Revista FIGURAS: Invierno</h3>
                        <p class="text-on-surface-variant small mb-3 line-clamp-2 d-none d-sm-block">Explora los artículos más recientes sobre humanidades digitales...</p>
                        <a class="mt-auto text-secondary-uim fw-bold text-uppercase tracking-widest text-decoration-none d-flex align-items-center gap-1"
                            href="#" style="font-size: 0.7rem;">
                            <span class="d-none d-sm-inline">Leer</span>
                            <i class="bi bi-chevron-right icon-transition fs-6"></i>
            ...
            <div class="col-6 col-md-6 col-lg-4">
                <article class="bg-surface-container-lowest rounded-4 overflow-hidden shadow-sm h-100 d-flex flex-column card-hover-premium group-arrow-hover">
                    ...
                    <div class="p-2 p-md-4 d-flex flex-column flex-grow-1">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <span class="bg-blue-50-uim text-primary-uim fw-bold text-uppercase tracking-widest px-2 py-1 rounded-pill d-none d-sm-inline-block"
                                style="font-size: 0.6rem;">Vinculación</span>
                            <span class="text-outline-uim font-label" style="font-size: 0.65rem;">Sep 28</span>
                        </div>
                        <h3 class="font-headline fs-6 fw-bold text-primary-uim mb-2" style="font-size: 0.85rem !important;">Alianza con institutos internacionales</h3>
                        <p class="text-on-surface-variant small mb-3 line-clamp-2 d-none d-sm-block">UIMA firma convenio de colaboración con universidades europeas...</p>
                        <a class="mt-auto text-secondary-uim fw-bold text-uppercase tracking-widest text-decoration-none d-flex align-items-center gap-1"
                            href="#" style="font-size: 0.7rem;">
                            <span class="d-none d-sm-inline">Leer</span>
                            <i class="bi bi-chevron-right icon-transition fs-6"></i>
