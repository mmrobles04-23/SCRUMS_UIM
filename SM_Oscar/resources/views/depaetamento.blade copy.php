...
$departamentos = [
'DTA' => ['nombre' => 'Dpto. de Tecnología Ambiental', 'color' => '#78D64B', 'logo' => 'uima_dta.png', 'icono' =>
'bi-tree', 'siglas' => 'DTA'],
'IPAJ' => ['nombre' => 'Dpto. de Investigación en Procuración y Administración de Justicia', 'color' => '#69B3E7',
'logo' => 'uima_ipaj.png', 'icono' => 'bi-bank', 'siglas' => 'IPAJ'],
'DPE' => ['nombre' => 'Dpto. de Proyección Empresarial', 'color' => '#DF1995', 'logo' => 'uima_dpe.png', 'icono' =>
'bi-briefcase', 'siglas' => 'DPE'],
'DIE' => ['nombre' => 'Dpto. de Investigación Educativa', 'color' => '#FA4616', 'logo' => 'uima_die.png', 'icono' =>
'bi-mortarboard', 'siglas' => 'DIE'],
'DICEC' => ['nombre' => 'Dpto. de Investigación en Comunicación y Estudios Culturales', 'color' => '#824F9E', 'logo' =>
'uima_dicec.png', 'icono' => 'bi-broadcast', 'siglas' => 'DICEC'],
'DRNA' => ['nombre' => 'Dpto. de Riesgos Naturales y Antropogénicos', 'color' => '#D50032', 'logo' => 'uima_drna.png',
'icono' => 'bi-exclamation-triangle', 'siglas' => 'DRNA'],
'DEGPP' => ['nombre' => 'Dpto. de Estudios de Gobierno y Política Pública', 'color' => '#26D07C', 'logo' =>
'uima_degpp.png', 'icono' => 'bi-building', 'siglas' => 'DEGPP'],
];
            ...
            <div class="row w-100 h-100 m-0 align-items-stretch">
                ...
                <div
                    ...
                    <div class="position-relative z-3 ps-lg-3 hero-text-container">
                        <h6
                            class="text-uppercase tracking-widest fw-bold mb-1 d-flex align-items-center gap-2 hero-subtitle">
                        ...
                        <p class="font-body mb-0 hero-description">
                            Investigación aplicada para comprender, prevenir y gestionar los retos que enfrentan la
                            sociedad y la
            ...
            <div class="container-fluid px-4 px-lg-5 py-4">
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-xl-3">
                        <div
                            ...
                            <div class="card-body p-4 p-xl-5 flex-column d-flex align-items-center text-center">
                                <div
                                    class="rounded-circle border border-4 overflow-hidden mb-4 shadow border-depto profile-avatar">
                                ...
                                <div class="w-100 border-top border-white border-opacity-10 pt-4 mt-auto text-start">
                                    <div class="d-flex align-items-center gap-3 mb-3">
                                        ...
                                        <span class="small font-light text-white-50">Edificio de Investigación, Cubículo
                                            104</span>
                                    </div>
                                    <div class="d-flex align-items-center gap-3 mb-3">
                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div
                            class="bg-surface-container-low p-4 p-md-5 rounded-4 h-100 shadow-sm border-depto objective-container">
                            ...
                            <p class="text-on-surface fs-5 lh-lg mb-5 font-body">
                                Caracterizar las acciones generadas por los distintos agentes perturbadores mediante el
                                análisis
                                riguroso de modelos estocásticos y deterministas. Buscamos establecer marcos
                                metodológicos que permitan
                                la prevención oportuna y la mitigación de impactos en infraestructuras críticas y
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 d-flex gap-3 align-items-start">
                                    <span class="fw-bold fs-4 lh-1 text-depto">•</span>
                                    <span class="text-on-surface-variant small pt-1">Análisis de vulnerabilidad
                                        estructural en zonas
                                        críticas.</span>
                                </div>
                                <div class="col-md-6 d-flex gap-3 align-items-start">
                                    <span class="fw-bold fs-4 lh-1 text-depto">•</span>
                                    <span class="text-on-surface-variant small pt-1">Consultoría especializada para
                                        entes
                                        gubernamentales.</span>
                                </div>
                                <div class="col-md-6 d-flex gap-3 align-items-start">
                                    <span class="fw-bold fs-4 lh-1 text-depto">•</span>
                                    <span class="text-on-surface-variant small pt-1">Monitoreo sísmico y alertamiento
                                        temprano.</span>
                                </div>
                                <div class="col-md-6 d-flex gap-3 align-items-start">
                                    <span class="fw-bold fs-4 lh-1 text-depto">•</span>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div
                            ...
                            <div class="position-relative overflow-hidden project-img-container">
                                <img alt="Riesgo Sísmico"
                                    class="w-100 h-100 object-fit-cover group-hover-scale project-img-scale"
                            ...
                            <div class="card-body p-4 d-flex flex-column">
                                <h4 class="h5 fw-bold text-primary-uim mb-3 font-headline">Evaluación de riesgo sísmico
                                </h4>
                                <p class="small text-on-surface-variant mb-4">Modelado avanzado de la respuesta dinámica
                                    del suelo en el
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div
                            ...
                            <div class="card-body p-4 d-flex flex-column">
                                <h4 class="h5 fw-bold text-primary-uim mb-3 font-headline">Caracterización de materiales
                                </h4>
                                <p class="small text-on-surface-variant mb-4">Estudio de concreto de alto desempeño y
                                    polímeros para
                    ...
                    <div class="col-md-6 col-xl-4 mx-auto">
                        <div
                            ...
                            <div class="card-body p-4 d-flex flex-column">
                                <h4 class="h5 fw-bold text-primary-uim mb-3 font-headline">Análisis de inundaciones
                                    pluviales</h4>
                                <p class="small text-on-surface-variant mb-4">Determinación de puntos críticos de
                                    anegamiento en zonas
